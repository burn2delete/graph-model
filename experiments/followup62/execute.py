"""Canonical deterministic execution wrapper for GDM62."""
...
class Encoder(GDM56Encoder):
    def __init__(self, *args, **kwargs):
        ...
        head["gdm62_execution_scope"] = "capability_and_ambiguity_heads"
        ...
        head["canonical_gdm61_audit_run"] = AUDIT61
        head["gdm62_change_scope"] = CHANGE_SCOPE
...
def main():
    ...
    def deterministic_interop(_requested):
        if torch.get_num_interop_threads() != 1:
            raise RuntimeError("GDM62 reproducibility contract requires one inter-op thread")
        return None
