"""Canonical deterministic execution wrapper for GDM58.

GDM58 inherits the canonical GDM50 numerical repair and canonical GDM56/GDM57
capability/curriculum/representation line. Only top-k semantic evidence breadth changes.
"""
...
class Encoder(GDM56Encoder):
    def __init__(self, *args, **kwargs):
        ...
        head["gdm58_execution_scope"] = "capability_and_ambiguity_heads"
...
def main():
    ...
    def deterministic_interop(_requested):
        if torch.get_num_interop_threads() != 1:
            raise RuntimeError("GDM58 reproducibility contract requires one inter-op thread")
        return None
