"""Canonical deterministic execution wrapper for GDM60.

GDM60 inherits the canonical GDM50 numerical repair and the GDM56–GDM59
capability/curriculum/ambiguity line. Only confidence scaling/factorization inside the
rank-preserving top-five request-relative ambiguity representation changes.
"""
...
SOURCE57 = "3f8b9a968285110ca6c744590724ddd0cb2bd5aa"
SOURCE58 = "9ba9caab957c1802feb17776195141f630fd96eb"
...
class Encoder(GDM56Encoder):
    def __init__(self, *args, **kwargs):
        ...
        head["gdm60_execution_scope"] = "capability_and_ambiguity_heads"
        ...
        head["canonical_gdm57_source_commit"] = SOURCE57
        head["canonical_gdm58_source_commit"] = SOURCE58
        head["canonical_gdm59_source_commit"] = SOURCE59
        head["canonical_gdm59_audit_run"] = AUDIT59
        head["gdm60_change_scope"] = (
...
def main():
    ...
    def deterministic_interop(_requested):
        if torch.get_num_interop_threads() != 1:
            raise RuntimeError("GDM60 reproducibility contract requires one inter-op thread")
        return None
