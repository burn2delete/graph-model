"""Canonical deterministic execution wrapper for GDM61."""
...
class Encoder(GDM56Encoder):
    def __init__(self, *args, **kwargs):
        ...
        head["gdm61_execution_scope"] = "capability_and_ambiguity_heads"
        ...
        head["canonical_gdm60_audit_run"] = AUDIT60
        head["gdm61_change_scope"] = CHANGE_SCOPE
...
def main():
    ...
    def deterministic_interop(_requested):
        if torch.get_num_interop_threads() != 1:
            raise RuntimeError("GDM61 reproducibility contract requires one inter-op thread")
        return None
